...
CREATE TABLE DimProducts(
	...
	CONSTRAINT FK_DimProductsTo_DimSuppliers FOREIGN KEY (SuppliersID) REFERENCES DimSuppliers (SupplierID),
	CONSTRAINT FK_DimProducts_To_DimWarehouses FOREIGN KEY (WarehouseID) REFERENCES DimWarehouses (WarehouseID)
)
...
CREATE TABLE DimEmployees(
	...
	DepID int NOT NULL,
	CONSTRAINT FK_DimEmployees_To_DimDepartaments FOREIGN KEY (DepID) REFERENCES DimDepartaments (DepID)
)

CREATE TABLE DimDepartaments(
	DepID int PRIMARY KEY NOT NULL,
	DepName nvarchar(50) NOT NULL
)


CREATE TABLE DimWarehouses(
